...
import com.mosi.tdpsync.modelo.CabeceraPedido;
import com.mosi.tdpsync.modelo.Cliente;
import com.mosi.tdpsync.modelo.DetallePedido;
import com.mosi.tdpsync.modelo.FormaPago;
import com.mosi.tdpsync.modelo.Producto;
...
public final class OperacionesBaseDatos {
    ...
    public Cursor rellenaListado(String cia, String cte, String id_pedido){
        SQLiteDatabase db = baseDatos.getWritableDatabase();

        final String sql = "SELECT invptmdesc,producto,unidades_vta,precio_pt from invptmtab,pedido_movil where "+
                 "compania = "+ cia
                 +"cliente = "+ cte
                 +"id_pedido = "+ id_pedido;
